...
<html>
	...
	<body>
		<jsp:useBean id="controller" class="actor4j.web.template.controller.DefaultActorServiceController" scope="session"/>
		...
		<p>Copyright (c) 2015-2018, David A. Bauer</p>
	</body>
</html>